  ...
  <Container>
   ...
   <div className='mt-[77px]'>
    ...
    <div className='flex justify-between'>
         <div className='group hover:bg-primary hover:border-primary pricing-box w-[450px] py-[40px] border border-[#DCE7FE] rounded-[20px] shadow-[1px_4px_4px_ opx_ rgba(0,0,0,0.25)]'>
                            <div className=' flex justify-center items-center w-[90px] h-[90px] rounded-full bg-[#E8F2FA] group hover:bg-white m-auto'>
                                {/* <img src={imagees} alt="imaees" /> */}
